...
/**
 * This extends Fee, so there are two ids (with getter and setter methods) in this domain object:
 * id = fee.id
 * accommodationFeeId = accommodationFee.id;
 * 
 * @author mp
 *
 */
public class AccommodationFee extends Fee {
