...
import org.uci.opus.fee.service.extpoint.AcademicYearFeeTransitionExtPoint;

@Component
public class AccommodationFeeTransition implements
        AcademicYearFeeTransitionExtPoint {

    @Autowired private AccommodationFeeMapper accommodationFeeMapper;

    @Override
    public void transfer(int sourceFeeId, int targetFeeId) {
        accommodationFeeMapper.transferAccommodationFee(sourceFeeId, targetFeeId);
    }
