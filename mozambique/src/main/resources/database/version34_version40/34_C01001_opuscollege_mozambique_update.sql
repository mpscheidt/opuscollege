...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('mozambique','A','Y',3.26);
...
INSERT INTO opuscollege.appConfig (startdate, enddate, appConfigAttributeName, appConfigAttributeValue)
    SELECT '2013-01-01','2013-12-31','academicYearOfAdmission', id FROM opuscollege.academicYear where description = '2014';
