...
-- Opus College (c) UCI - Stelio Macumbe - July 4 , 2012
--
...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('scholarship','A','Y', 3.29);

-- Table: audit.sch_sponsor_hist

DROP TABLE IF EXISTS audit.sch_sponsor_hist;

CREATE TABLE audit.sch_sponsor_hist
(
...
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.sch_sponsor_hist TO postgres;


-- Table: audit.sch_sponsorfeepercentage_hist

DROP TABLE IF EXISTS audit.sch_sponsorfeepercentage_hist;

CREATE TABLE audit.sch_sponsorfeepercentage_hist
(
  operation character(1) NOT NULL,
  id integer NOT NULL ,
...
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.sch_sponsorfeepercentage_hist TO postgres;
