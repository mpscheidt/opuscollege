...
-- OPTIONAL SCRIPT: if the column academicYearCode already exists, skip this script.

ALTER TABLE opuscollege.sch_scholarship ADD column academicYearCode VARCHAR NOT NULL DEFAULT '';
