 ...
 *
 */
public class ScholarshipDeleteController extends AbstractController {
    
    private static Logger log = LoggerFactory.getLogger(ScholarshipDeleteController.class);
     ...
     */     
    public ScholarshipDeleteController() {
        super();
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        if (scholarshipId != 0) {
            showError = scholarshipManager.deleteScholarship(scholarshipId);
        }
        ModelAndView mav = new ModelAndView();
        mav.setViewName("redirect:/scholarship/scholarships.view");
        mav.getModelMap().put("showError", showError);
        mav.getModelMap().put("sponsorId", request.getParameter("sponsorId"));
        mav.getModelMap().put("academicYearId", request.getParameter("academicYearId"));
