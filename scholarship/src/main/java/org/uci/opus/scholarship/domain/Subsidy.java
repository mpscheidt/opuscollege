...
public class Subsidy {
    ...
    public String getSubsidyTypeCode() {
        return subsidyTypeCode;
    }
    public void setSubsidyTypeCode(final String subsidyTypeCode) {
        this.subsidyTypeCode = subsidyTypeCode;
    }
    public int getSponsorId() {
        return sponsorId;
    }
    public void setSponsorId(final int sponsorId) {
    ...
    public void setSubsidyDate(final Date subsidyDate) {
