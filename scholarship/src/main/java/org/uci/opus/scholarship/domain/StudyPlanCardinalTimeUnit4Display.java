...
public class StudyPlanCardinalTimeUnit4Display {

    private StudyPlanCardinalTimeUnit studyPlanCardinalTimeUnit;
    private StudyPlan studyPlan;
    private TimeUnit timeUnit;

    public StudyPlanCardinalTimeUnit4Display(StudyPlanCardinalTimeUnit studyPlanCardinalTimeUnit) {
    ...
    public void setTimeUnitInYear(TimeUnit timeUnit) {
