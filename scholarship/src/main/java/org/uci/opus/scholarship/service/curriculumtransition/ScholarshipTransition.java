...
@Component
public class ScholarshipTransition implements
    ...
    public void transfer(int sourceAcademicYearId, int targetAcademicYearId) {
        ...
        sponsorMapper.transferSponsors(sourceAcademicYearId, targetAcademicYearId);
        scholarshipMapper.transferScholarships(sourceAcademicYearId, targetAcademicYearId);
        scholarshipFeePercentageMapper.transferScholarshipFeePercentages(sourceAcademicYearId, targetAcademicYearId);
    }

    @Override
    public int getOrder() {
        // scholarship does not depend on any other, 
