...
public interface SponsorInvoiceMapper {
    ...
    void addSponsorInvoice(SponsorInvoice sponsorInvoice);

    void updateSponsorInvoice(SponsorInvoice sponsorInvoice);

    int deleteSponsorInvoice(int sponsorInvoiceId);

    boolean doesSponsorInvoiceExist(Map<String, Object> params);

    void insertSponsorInvoiceHistory(@Param("sponsorInvoice") SponsorInvoice sponsorInvoice, @Param("operation") String operation);
