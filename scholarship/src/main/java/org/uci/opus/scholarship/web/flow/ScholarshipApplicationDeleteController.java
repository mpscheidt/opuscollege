 ...
 *
 */
public class ScholarshipApplicationDeleteController extends AbstractController {
    
    private static Logger log = LoggerFactory.getLogger(ScholarshipApplicationDeleteController.class);
     ...
     */     
    public ScholarshipApplicationDeleteController() {
        super();
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        String showScholarshipApplicationError = "";
        int tab = 0;
        int panel = 0;
        ...
        // delete chosen scholarshipApplication:
        if (scholarshipApplicationId != 0) {
            scholarshipManager.deleteScholarshipApplication(scholarshipApplicationId); 
        }
        
        ModelAndView mav = new ModelAndView();
        mav.setViewName("redirect:/scholarship/scholarshipstudent.view");
        mav.getModelMap().put("showScholarshipApplicationError", showScholarshipApplicationError);
