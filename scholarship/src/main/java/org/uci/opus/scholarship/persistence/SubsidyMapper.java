...
public interface SubsidyMapper {
    ...
    /**
     * Delete all subsidies for a student.
     * @param scholarshipStudentId
     * @return List of Subsidy objects or null
     */    
    List<Subsidy> findStudentSubsidies(int scholarshipStudentId);

    /**
     * Delete all subsidies for one scholarshipstudent.
     * @param scholarshipStudentId
     */    
    void deleteSubsidiesForStudent(int scholarshipStudentId);
     ...
     */    
    Subsidy findSubsidy(int subsidyId);
     ...
     */
    List<Map<String, Object>> findSubsidies(Map<String, Object> map);

    /**
     * add a Subsidy
     * @param Subsidy to add
     * @return id of the new Subsidy
     */
    void addSubsidy(Subsidy subsidy);
     ...
     * @return
     */
    void deleteSubsidy(int subsidyId);
