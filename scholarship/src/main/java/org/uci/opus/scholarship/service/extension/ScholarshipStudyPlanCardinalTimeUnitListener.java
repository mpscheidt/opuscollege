...
/**
 * This extension deals with the automatic transfer of scholarships to new time units for eligible students.
 * @author markus
 *
 */
@Service
public class ScholarshipStudyPlanCardinalTimeUnitListener implements IStudyPlanCardinalTimeUnitListener {
    
    @Autowired private ScholarshipManagerInterface scholarshipManager;

    @Override
    public void studyPlanCardinalTimeUnitAdded(StudyPlanCardinalTimeUnit newStudyPlanCardinalTimeUnit,
            StudyPlanCardinalTimeUnit previousStudyPlanCardinalTimeUnit,
            HttpServletRequest request) {

        scholarshipManager.transferScholarship(newStudyPlanCardinalTimeUnit, previousStudyPlanCardinalTimeUnit);
