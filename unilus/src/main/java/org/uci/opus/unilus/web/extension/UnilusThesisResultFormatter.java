...
public class UnilusThesisResultFormatter extends ThesisResultFormatter {
    ...
    public String get(Object obj) {
        ...
        s.append(thesisResult.getMark());
        s.append(" (");
        if (thesisResult.getEndGrade() != null) {
            s.append(thesisResult.getEndGrade());
        }
        s.append(")");
        return s.toString();
    }
