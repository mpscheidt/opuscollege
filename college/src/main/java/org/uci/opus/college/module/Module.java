...
public class Module implements Ordered, Serializable {
    ...
    private AppVersionAccessor appVersionAccessor;
    ...
    public AppVersionAccessor getAppVersionAccessor() {
        return appVersionAccessor;
    }

    public void setAppVersionAccessor(AppVersionAccessor appVersionAccessor) {
        this.appVersionAccessor = appVersionAccessor;
    }
