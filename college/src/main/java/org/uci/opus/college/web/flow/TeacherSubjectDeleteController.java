...
@Controller
@RequestMapping("/college/teachersubject_delete.view")
public class TeacherSubjectDeleteController {
    
     private static Logger log = LoggerFactory.getLogger(TeacherSubjectDeleteController.class);
	...
	public TeacherSubjectDeleteController() {
		super();
...
//        String from = "";
        ...
        return "redirect:/college/staffmember.view?newForm=true&tab=" + tab + "&panel=" + panel 
