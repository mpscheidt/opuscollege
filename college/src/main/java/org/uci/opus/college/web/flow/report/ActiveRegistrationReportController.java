...
@Controller
@RequestMapping(value="/college/report/activeregistration.view")
public class ActiveRegistrationReportController  {

    private static Logger log = LoggerFactory.getLogger(ActiveRegistrationReportController.class);
   ...
   public ActiveRegistrationReportController() {
       super();       
   }
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
        ...
        String reportName = ServletUtil.getParamSetAttrAsString(request, "reportName", "ActiveRegistration");
        String reportFullName = "person/" + reportName;//full path to report
         ...
         String requestWhereClause = reportController.generateSQLWhereClause(request);
            ...
            reportController.putModelParameters(mav, getUserProperties("ActiveRegistration"));
