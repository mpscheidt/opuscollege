...
public class TestTeacherForm {
    ...
    private List < TestTeacher > allTestTeachers = null;
    private List <Test> allTests;
    private List <Classgroup> allClassgroups;

    private List < StaffMember > allTeachers = null;
    ...
    public TestTeacher getTestTeacher() {
        return testTeacher;
    }
    public void setTestTeacher(final TestTeacher testTeacher) {
    ...
    public List < TestTeacher > getAllTestTeachers() {
        return allTestTeachers;
    }
    public void setAllTestTeachers(
            final List < TestTeacher > allTestTeachers) {
        this.allTestTeachers = allTestTeachers;
    }
    public List < StaffMember > getAllTeachers() {
        return allTeachers;
    }
    public void setAllTeachers(final List < StaffMember > allTeachers) {
