...
public class ProgressCalculationDefault implements ProgressCalculation {

    /**
     * Default class: to calculate the progress status for a studyplancardinaltimeunit
    ...
    /**
	 * Default class: if the progress status is 'PROCEED' (only for the Zambian situation):
	 ...
	 * 
     * @see org.uci.opus.college.service.ProgressCalculation
     *      #proceedCheck(
     *      org.uci.opus.college.domain.Lookup7, java.util.List, int, boolean)
     */
    @Override
