...
/**
 * Use subject description to sort subjects.
 * (Eventually add parameter to include subject code for sorting.)
 *
 * @author markus
 */
public class SubjectComparator implements Comparator<Subject> {
    ...
    public int compare(Subject o1, Subject o2) {
        ...
        String description1 = o1.getSubjectDescription();
        String description2 = o2.getSubjectDescription();
        
        if (description1 == null) description1 = "";
        if (description2 == null) description2 = "";
        
        int result = coll.compare(description1, description2);
        return result;
    }
