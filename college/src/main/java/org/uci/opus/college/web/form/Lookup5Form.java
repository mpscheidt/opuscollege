...
public class Lookup5Form {
    ...
    private List<Lookup5> lookups;
    private List<Lookup3> countries;
    ...
    public List<Lookup5> getLookups() {
        return lookups;
    }

    public void setLookups(List<Lookup5> lookups) {
     ...
     * @return this lookups
     */
    public List<Lookup5> createNewLookups(List<String> languages) {

        List<Lookup5> newLookups = new ArrayList<Lookup5>(languages.size());
    ...
    public List<Lookup3> getCountries() {
        return countries;
    }

    public void setCountries(List<Lookup3> countries) {
