...
public class ThesisSupervisorForm {
    ...
    public ThesisSupervisorForm() {
        thesisSupervisor = new ThesisSupervisor();
    }

    public ThesisSupervisor getThesisSupervisor() {
        return thesisSupervisor;
    }

    public void setThesisSupervisor(final ThesisSupervisor thesisSupervisor) {
