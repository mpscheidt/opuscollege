...
public class ThesisStatusForm {

    private ThesisStatus thesisStatus;
    private Thesis thesis;
    private StudyPlan studyPlan;
    private Student student;
    private List < ? extends Lookup > allThesisStatuses;
    
    private NavigationSettings navigationSettings;
    
    public ThesisStatusForm() {
        thesisStatus = new ThesisStatus();
    }


    public ThesisStatus getThesisStatus() {
        return thesisStatus;
    }

    public void setThesisStatus(final ThesisStatus thesisStatus) {
    ...
    public List<? extends Lookup> getAllThesisStatuses() {
        return allThesisStatuses;
    }

    public void setAllThesisStatuses(final List< ? extends Lookup > allThesisStatuses) {
