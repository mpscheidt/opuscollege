 ...
 */
@Controller
@RequestMapping("/college/obtainedqualification_delete.view")
public class ObtainedQualificationDeleteController {
     ...
     */     
    public ObtainedQualificationDeleteController() {
        super();
    ...
    protected final String deleteObtainedQualificationPost(HttpServletRequest request) 
        ...
        return deleteObtainedQualification(request);

    }
    
    @RequestMapping(method=RequestMethod.GET)
    protected String deleteObtainedQualification(HttpServletRequest request) {
        ...
        int obtainedQualificationId = Integer.parseInt(request.getParameter("obtainedQualificationId"));
        ...
        if (obtainedQualificationId != 0) {
            studyManager.deleteObtainedQualification(obtainedQualificationId);
        }
