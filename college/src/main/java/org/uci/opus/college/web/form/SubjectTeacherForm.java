...
public class SubjectTeacherForm {
	...
	// subject needed to show in cumbs path
	Subject subject;

	// lists
	private List<? extends StaffMember> allUnboundTeachers;
	private List<? extends SubjectTeacher> allBoundTeachers;
	...
	public void setSubjectTeacher(final SubjectTeacher subjectTeacher) {
	...
	public List<? extends StaffMember> getAllUnboundTeachers() {
		return allUnboundTeachers;
	}

	public void setAllUnboundTeachers(final List<? extends StaffMember> allUnboundTeachers) {
		this.allUnboundTeachers = allUnboundTeachers;
	}
	...
	public List<? extends SubjectTeacher> getAllBoundTeachers() {
		return allBoundTeachers;
	}

	public void setAllBoundTeachers(
			final List<? extends SubjectTeacher> allBoundTeachers) {
		this.allBoundTeachers = allBoundTeachers;
	}
