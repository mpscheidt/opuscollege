...
public class DisciplineForm {
	...
	List<? extends Lookup> disciplinesSet;
	...
	public List<? extends Lookup> createNewDisciplinesSet(List<String> languages) {
		
		List<Lookup> disciplinesSet = new ArrayList<Lookup>();
	...
	public List<? extends Lookup> getDisciplinesSet() {
		return disciplinesSet;
	}


	public void setDisciplinesSet(List<? extends Lookup> disciplinesSet) {
