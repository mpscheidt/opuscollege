...
public class ObtainedQualification implements Serializable {
    ...
    private Date endGradeDate;
    private String qualification;
    private String gradeTypeCode;
    
    public ObtainedQualification() {
    ...
    public Date getEndGradeDate() {
        return endGradeDate;
    }

    public void setEndGradeDate(Date endGradeDate) {
