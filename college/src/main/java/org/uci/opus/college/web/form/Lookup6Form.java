...
public class Lookup6Form {
	...
	public List<Lookup6> getLookups() {
		return lookups;
	}


	public void setLookups(List<Lookup6> lookups) {
	 ...
	 * @return this lookups
	 */
	public List<Lookup6> createNewLookups(List<String> languages){
		
		List<Lookup6> newLookups = new ArrayList<Lookup6>(languages.size());
	...
	public String getLookupTitleShort() {
		return lookupTitleShort;
	}

	public void setLookupTitleShort(String lookupTitleShort) {
		this.lookupTitleShort = lookupTitleShort;
	}
