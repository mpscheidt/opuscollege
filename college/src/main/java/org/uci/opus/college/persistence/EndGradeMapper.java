...
public interface EndGradeMapper {

	/**
	 * Gets all endgrades in a particular idiom, if lang set null every endgrade is returned	
	 * @param lang 
	 * @return
	 */
	List<? extends EndGrade> findEndGrades(Map<String, Object> params);
	 ...
	 */
	void deleteEndGradeSet(@Param("code") String code, @Param("endGradeTypeCode") String endGradeTypeCode, 
	 ...
	 * @param map
	 */
	void updateEndGradeHistory(Map<String, Object> map);
	 ...
	 * @return
	 */
	List<EndGradeHistory> findEndGradeHistory(Map<String, Object> map);
