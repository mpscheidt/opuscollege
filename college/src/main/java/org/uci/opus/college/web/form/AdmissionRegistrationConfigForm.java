...
public class AdmissionRegistrationConfigForm {
    
    private NavigationSettings navigationSettings;

    private AdmissionRegistrationConfig admissionRegistrationConfig;
    private OrganizationalUnit organizationalUnit;
    private List<AcademicYear> allAcademicYears;
    

    public void setAdmissionRegistrationConfig(
            AdmissionRegistrationConfig admissionRegistrationConfig) {
        this.admissionRegistrationConfig = admissionRegistrationConfig;
    }

    public AdmissionRegistrationConfig getAdmissionRegistrationConfig() {
