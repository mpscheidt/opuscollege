...
public class Lookup7 extends Lookup {
	...
	/**
	 * @return the continuing
	 */
	public String getContinuing() {
		return continuing;
	}
	/**
	 * @param continuing the continuing to set
	 */
	...
	/**
	 * @return the graduating
	 */
	public String getGraduating() {
		return graduating;
	}
	/**
	 * @param graduating the graduating to set
	 */
	public void setGraduating(final String graduating) {
	 ...
	 */
	public void setCarrying(final String carrying) {
