...
public class Lookup4Form {
    ...
    private List<Lookup4> lookups;
    private List<Lookup2> districts;

    private String lookupTable;
    private String lookupCode;
    private String lookupActive;
    private String lookupDistrictCode;
    ...
    public List<Lookup4> getLookups() {
        return lookups;
    }

    public void setLookups(List<Lookup4> lookups) {
     ...
     * @return this lookups
     */
    public List<Lookup4> createNewLookups(List<String> languages) {

        List<Lookup4> newLookups = new ArrayList<Lookup4>(languages.size());
    ...
    public List<Lookup2> getDistricts() {
        return districts;
    }

    public void setDistricts(List<Lookup2> districts) {
        this.districts = districts;
    }

    public String getLookupDistrictCode() {
        return lookupDistrictCode;
    }

    public void setLookupDistrictCode(String lookupDistrictCode) {
        this.lookupDistrictCode = lookupDistrictCode;
    }
