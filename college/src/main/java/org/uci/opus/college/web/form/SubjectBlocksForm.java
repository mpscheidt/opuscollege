...
public class SubjectBlocksForm {
    ...
    private List < ? extends SubjectBlock > allSubjectBlocks;
    private List < ? extends AcademicYear > allAcademicYears;
    
    // errors
    private String subjectBlockError;
    
    // utility
    private IdToAcademicYearMap idToAcademicYearMap;
    
    
    public SubjectBlocksForm() {
        this.subjectBlockError = "";
    }
    ...
    public String getSubjectBlockError() {
        return subjectBlockError;
    }

    public void setSubjectBlockError(final String subjectBlockError) {
        this.subjectBlockError = subjectBlockError;
    }
