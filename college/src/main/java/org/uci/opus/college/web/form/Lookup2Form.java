...
public class Lookup2Form {
    ...
    private List<Lookup2> lookups;
    private List<Lookup5> provinces;

    private String lookupTable;
    private String lookupCode;
    private String lookupActive;
    private String lookupProvinceCode;
    ...
    public List<Lookup2> getLookups() {
        return lookups;
    }

    public void setLookups(List<Lookup2> lookups) {
     ...
     * @return this lookups
     */
    public List<Lookup2> createNewLookups(List<String> languages) {

        List<Lookup2> newLookups = new ArrayList<Lookup2>(languages.size());
    ...
    public List<Lookup5> getProvinces() {
        return provinces;
    }

    public void setProvinces(List<Lookup5> provinces) {
        this.provinces = provinces;
    }

    public String getLookupProvinceCode() {
        return lookupProvinceCode;
    }

    public void setLookupProvinceCode(String lookupProvinceCode) {
        this.lookupProvinceCode = lookupProvinceCode;
    }
