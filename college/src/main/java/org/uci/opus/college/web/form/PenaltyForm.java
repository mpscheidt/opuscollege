...
public class PenaltyForm {
    ...
    public List < ? extends Lookup > getAllPenaltyTypes() {
        return allPenaltyTypes;
    }
    public void setAllPenaltyTypes(final List < ? extends Lookup > allPenaltyTypes) {
        this.allPenaltyTypes = allPenaltyTypes;
    }
