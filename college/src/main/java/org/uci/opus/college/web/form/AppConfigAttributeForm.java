...
public class AppConfigAttributeForm {
	
	private AppConfigAttribute appConfigAttribute;
	...
	public AppConfigAttributeForm() {
		txtErr = "";
		txtMsg = "";
	}

	public AppConfigAttribute getAppConfigAttribute() {
		return appConfigAttribute;
	}

	public void setAppConfigAttribute(AppConfigAttribute appConfigAttribute) {
		this.appConfigAttribute = appConfigAttribute;
	}
