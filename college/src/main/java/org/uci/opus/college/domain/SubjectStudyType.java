...
/**
 * @author J. Nooitgedagt Object is a studyType connected to a subject
 *
 */
public class SubjectStudyType implements Serializable {
    ...
    public void setStudyTypeDescription(String studyTypeDescription) {
