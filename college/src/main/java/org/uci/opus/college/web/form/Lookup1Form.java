...
public class Lookup1Form {
	 ...
	 */
    private List<Lookup1> lookups;
	
	private String lookupTable;
	private String lookupCode;
	private String lookupActive;
	private String lookupDescriptionShort;
	...
	public List<Lookup1> getLookups() {
		return lookups;
	}


	public void setLookups(List<Lookup1> lookups) {
	 ...
	 * @return this lookups
	 */
	public List<Lookup1> createNewLookups(List<String> languages){
		
		List<Lookup1> newLookups = new ArrayList<Lookup1>(languages.size());
	...
	public String getLookupDescriptionShort() {
		return lookupDescriptionShort;
	}


	public void setLookupDescriptionShort(String lookupDescriptionShort) {
		this.lookupDescriptionShort = lookupDescriptionShort;
	}
