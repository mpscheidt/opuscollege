...
public class StudySettings {
    ...
    private Lookup studyPlanStatus;

    public StudySettings() {
        studyId = 0;
        studyGradeTypeId = 0;
        studyPlanStatus = new Lookup();
    }
     ...
     *            the cardinalTimeUnitNumber to set
     */
    public void setCardinalTimeUnitNumber(final Integer cardinalTimeUnitNumber) {
    ...
    public Lookup getStudyPlanStatus() {
        return studyPlanStatus;
    }

    public void setStudyPlanStatus(final Lookup studyPlanStatus) {
