...
public class InstitutionForm {
    ...
    private List<Lookup> allInstitutionTypes;
    ...
    public List<Lookup> getAllInstitutionTypes() {
        return allInstitutionTypes;
    }

    public void setAllInstitutionTypes(List<Lookup> allInstitutionTypes) {
        this.allInstitutionTypes = allInstitutionTypes;
    }
