...
public class AcademicYearsForm {
	...
	private IdToAcademicYearMap academicYearsMap;
	
	public AcademicYearsForm() {
		txtErr = "";
		txtMsg = "";
	}
	...
	public IdToAcademicYearMap getAcademicYearsMap() {
		return academicYearsMap;
	}

	public void setAcademicYearsMap(IdToAcademicYearMap academicYearsMap) {
		this.academicYearsMap = academicYearsMap;
	}
