...
public class IdToSubjectMap
    extends DummyMap<Number, Subject>
    implements Map<Number, Subject> {

    private List<? extends Subject> list;
    private Map<Number, ? extends Subject> map = null;
    
    public IdToSubjectMap(List<? extends Subject> list) {
        this.list = list;
    }
