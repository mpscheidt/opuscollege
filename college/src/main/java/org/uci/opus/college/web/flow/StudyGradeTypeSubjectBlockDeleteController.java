...
public class StudyGradeTypeSubjectBlockDeleteController extends AbstractController {

    private static Logger log = LoggerFactory.getLogger(StudyGradeTypeSubjectBlockDeleteController.class);
    ...
    */     
   public StudyGradeTypeSubjectBlockDeleteController() {
       super();
   }
...
//           HashMap <String , Object> findSubjectBlockStudyGradeTypeMap = new HashMap <String , Object>();
...
//           findSubjectBlockStudyGradeTypeMap.put("subjectBlockStudyGradeTypeId", subjectBlockStudyGradeTypeId);
           SubjectBlockStudyGradeType subjectBlockStudyGradeType = 
                   subjectBlockMapper.findSubjectBlockStudyGradeType(subjectBlockStudyGradeTypeId, preferredLanguage);
           ...
           HashMap <String , Object> findResultsMap = new HashMap <String , Object>();
               ...
               for (int i = 0; i < examinationResults.size(); i++) {
                   ...
                   if (examinationResultList.size() != 0 && showSubjectBlockStudyGradeTypeError == "") {
                       ...
                       for (int j = 0; j < testResults.size(); j++) {
                           ...
                           testResultList = resultManager.findTestResults(testResult.getTestId());
                           if (testResultList.size() != 0 
                               ...
                               showSubjectBlockStudyGradeTypeError += "error!";
                           }
                       }
                   }
               }
           ...
           if (StringUtil.isNullOrEmpty(showSubjectBlockStudyGradeTypeError)) {
        	   ...
        	   subjectManager.deleteSubjectBlockStudyGradeType(
            		   subjectBlockStudyGradeTypeId, request);
           }
       }       
       
       String nextView =  "redirect:/college/studygradetype.view?newForm=true&tab=" + tab 
                   + "&panel=" + panel + "&studyGradeTypeId=" + studyGradeTypeId
                   + "&studyId=" + studyId
