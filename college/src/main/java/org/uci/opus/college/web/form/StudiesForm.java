...
//	private List < ? extends OrganizationalUnit > organizationalUnitsForStudies;

	private IdToOrganizationalUnitMap idToOrganizationalUnitMap;
	private IdToBranchMap idToBranchMap;
    ...
    public IdToBranchMap getIdToBranchMap() {
        return idToBranchMap;
    }

    public void setIdToBranchMap(IdToBranchMap idToBranchMap) {
        this.idToBranchMap = idToBranchMap;
    }
