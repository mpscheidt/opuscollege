...
public class LookupForm {
	...
	public List<? extends Lookup> getLookups() {
		return lookups;
	}


	public void setLookups(List<? extends Lookup> lookups) {
	 ...
	 * @return this lookups
	 */
	public List<Lookup> createNewLookups(List<String> languages){
		
		List<Lookup> newLookups = new ArrayList<Lookup>(languages.size());
