...
public class Lookup9 extends Lookup {
    ...
    public Lookup9(String lang, String code, String description, String title) {
        super(lang, code, description);
        this.title = title;
    }

    public Lookup9(String lang, String code, String description, String title, String educationAreaCode, String educationLevelCode) {
        this(lang, code, description, title);
