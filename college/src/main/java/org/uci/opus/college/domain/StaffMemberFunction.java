 ...
 *
 */
public class StaffMemberFunction implements Serializable {
    ...
    public void setFunctionLevelCode(String newFunctionLevelCode) {
        functionLevelCode = newFunctionLevelCode;
    }
