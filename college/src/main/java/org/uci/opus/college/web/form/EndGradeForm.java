...
public class EndGradeForm {

	/**
	 * Stores common values for endgrades
	 */
	private EndGrade modelEndGrade;
	...
	List<? extends Lookup> endGradeTypes;
	...
	public List<? extends EndGrade> createNewEndGrades(List<String> languages) {
		
		List<EndGrade> newEndGrades = new ArrayList<>();
		
		for(String lang: languages) {
			
			EndGrade endGrade = new EndGrade(lang);
			newEndGrades.add(endGrade);
		}
		
		return newEndGrades;
	}
	
	public EndGrade getModelEndGrade() {
		return modelEndGrade;
	}

	public void setModelEndGrade(EndGrade modelEndGrade) {
		this.modelEndGrade = modelEndGrade;
	}
	...
	public List<? extends EndGrade> getEndGrades() {
		return endGrades;
	}

	public void setEndGrades(List<? extends EndGrade> endGrades) {
		this.endGrades = endGrades;
	}

	public List<? extends Lookup> getEndGradeTypes() {
		return endGradeTypes;
	}

	public void setEndGradeTypes(List<? extends Lookup> endGradeTypes) {
		this.endGradeTypes = endGradeTypes;
	}
