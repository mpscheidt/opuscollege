...
@Controller
@RequestMapping(value="/register_admissionsummary.view")
public class AdmissionSummaryReportController  {

    private static Logger log = LoggerFactory.getLogger(AdmissionSummaryReportController.class);
    ...
    public AdmissionSummaryReportController() {
        super();
    }
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
        ...
        String reportName = "AdmissionSummary";
        String reportFullName = "person/" + reportName;//full path to report
         ...
         String requestWhereClause = reportController.generateSQLWhereClause(request);
            ...
            reportController.putModelParameters(mav, getUserProperties("admissionsummary"));
