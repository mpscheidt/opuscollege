...
public class Lookup8Form {
     ...
     */
    private List<Lookup8> lookups;

    private String lookupTable;
    private String lookupCode;
    private String lookupActive;
    private int lookupNrOfUnitsPerYear;
    ...
    public List<Lookup8> getLookups() {
        return lookups;
    }

    public void setLookups(List<Lookup8> lookups) {
     ...
     * @return this lookups
     */
    public List<Lookup8> createNewLookups(List<String> languages) {

        List<Lookup8> newLookups = new ArrayList<Lookup8>(languages.size());
    ...
    public int getLookupNrOfUnitsPerYear() {
        return lookupNrOfUnitsPerYear;
    }

    public void setLookupNrOfUnitsPerYear(int lookupNrOfUnitsPerYear) {
        this.lookupNrOfUnitsPerYear = lookupNrOfUnitsPerYear;
    }
