 ...
 *
 */
public interface InstitutionManagerInterface {

    List<Institution> findInstitutions(final Map<String, Object> findInstitutionsMap);
    
    /**
     * @param branchId id of institution to find
     * @return institutionId
     */
    int findInstitutionOfBranch(final int branchId);
    
    /**
     * @param institutionId id of institution to find
     * @return institution
     */   
    Institution findInstitution(final int institutionId);

    /**
     * @param institution to add
     * @return
     */    
    void addInstitution(final Institution institution);

    /**
     * @param institution to update
     * @return
     */    
