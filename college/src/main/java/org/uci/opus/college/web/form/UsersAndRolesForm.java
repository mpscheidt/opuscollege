...
public class UsersAndRolesForm {
	...
	List < Role > allRoles ;
	List < ? extends OrganizationalUnit > organizationalUnitsForUsers;
	
	public UsersAndRolesForm() {
		txtErr = "";
		txtMsg = "";
	}
    ...
    public List<? extends OrganizationalUnit> getOrganizationalUnitsForUsers() {
        return organizationalUnitsForUsers;
    }

    public void setOrganizationalUnitsForUsers(
            List<? extends OrganizationalUnit> organizationalUnitsForUsers) {
        this.organizationalUnitsForUsers = organizationalUnitsForUsers;
    }
