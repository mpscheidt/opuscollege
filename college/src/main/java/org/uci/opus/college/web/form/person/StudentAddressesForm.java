...
public class StudentAddressesForm implements IStudentForm {
    ...
    @Override
    public void setStudentFormShared(StudentFormShared shared) {
        this.studentFormShared = shared;
    }
     ...
     */
    public void setAllAddressTypes(final List<Lookup> allAddressTypes) {
