...
public class StudentStudentStatusForm {

    private NavigationSettings navigationSettings;
    private List<Lookup> allStudentStatuses;

    private StudentStudentStatus studentStudentStatus;
    ...
    public StudentStudentStatus getStudentStudentStatus() {
        return studentStudentStatus;
    }

    public void setStudentStudentStatus(StudentStudentStatus studentStudentStatus) {
        this.studentStudentStatus = studentStudentStatus;
    }
