...
<input type="hidden" name="navigationSettings.tab" value="${navigationSettings.tab}" />
<input type="hidden" name="navigationSettings.panel" value="${navigationSettings.panel}" />
<input type="hidden" name="navigationSettings.currentPageNumber" value="${navigationSettings.currentPageNumber}" />
...
<sec:authorize access="hasAnyRole('UPDATE_BRANCHES','UPDATE_INSTITUTIONS')">
    <table>
        <tr>
            ...
            <td width="200" align="right">
            <select name="organization.branchId" id="organization.branchId" onchange="document.getElementById('organization.organizationalUnitId').value='0';document.formdata.submit();">
                <option value="0"><fmt:message key="jsp.selectbox.all" /></option>
...
<sec:authorize access="hasAnyRole('READ_PRIMARY_AND_CHILD_ORG_UNITS','UPDATE_ORG_UNITS','UPDATE_BRANCHES','UPDATE_INSTITUTIONS')">
    ...
    <tr>
        ...
        <select name="organization.organizationalUnitId" id="organization.organizationalUnitId" onchange="document.formdata.submit();">
