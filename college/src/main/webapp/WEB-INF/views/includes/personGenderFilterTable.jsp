...
--%>
            ...
            <table>
                <tr>
                    ...
                    <td width="200">
                    <select name="genderCode" id="genderCode" onchange="
                        ...
                        <c:forEach var="gender" items="${allGenders}">
                             <c:choose>
                                  <c:when test="${(genderCode != null && genderCode != 0 
                                      ...
                                      <option value="${gender.code}" selected="selected"><c:out value="${gender.description}"/></option>
                                  </c:when>
                                  <c:otherwise>
                                      <option value="${gender.code}"><c:out value="${gender.description}"/></option>
                                  </c:otherwise>
                              </c:choose>
                        </c:forEach>
                    </select>
