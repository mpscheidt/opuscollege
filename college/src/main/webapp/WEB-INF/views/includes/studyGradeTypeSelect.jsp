...
--%>
            ...
            <table>
                <tr>
                    ...
                    <td>
                    <select name="studyGradeTypeId" onchange="document.getElementById('searchValue').value='';document.getElementById('studyYearId').value='0';document.studygradetypes.submit();">-->
               
               
               
                    <select name="studyGradeTypeId" onchange="this.form.submit();">
