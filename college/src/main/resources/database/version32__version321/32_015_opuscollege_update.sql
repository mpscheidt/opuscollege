...
UPDATE opuscollege.lookuptable SET active = 'N' where lower(tablename) = 'endgradetype';

-------------------------------------------------------
-- table subject
-------------------------------------------------------

ALTER TABLE opuscollege.subject ADD COLUMN subjectImportanceCode VARCHAR;
