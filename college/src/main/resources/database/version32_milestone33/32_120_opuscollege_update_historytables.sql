...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('college','A','Y',3.49);

-------------------------------------------------------
-- Table: audit.thesisResult_Hist
-------------------------------------------------------

-- DROP TABLE audit.thesisResult_Hist;

CREATE TABLE audit.thesisresult_Hist
(
...
GRANT ALL ON TABLE audit.thesisResult_Hist TO postgres;

-------------------------------------------------------
-- Table: audit.studyPlanResult_Hist
-------------------------------------------------------

-- DROP TABLE audit.studyPlanResult_Hist;

CREATE TABLE audit.studyPlanResult_Hist
(
  operation character(1) NOT NULL CHECK (operation IN ('I','D','U')),
  writewho character varying NOT NULL,
  writewhen timestamp without time zone NOT NULL DEFAULT now(),
...
GRANT ALL ON TABLE audit.studyPlanResult_Hist TO postgres;
