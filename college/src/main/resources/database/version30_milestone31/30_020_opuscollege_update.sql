...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('college','A','Y',3.04);

/**
Finds tables with academicyearcode column and replace it with academicyearid
Replace codes with ids 
It is adviced to call this function after a new module which may contain ademic year code references is installed
**/
