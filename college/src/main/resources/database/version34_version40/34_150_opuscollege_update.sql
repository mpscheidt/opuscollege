...
VALUES('college','A','Y',3.77);

-------------------------------------------------------
-- temp tables and sequences
-------------------------------------------------------
...
drop sequence if exists opuscollege.financialtransactiontmpseq;
drop sequence if exists opuscollege.studentbalancetmpseq;
