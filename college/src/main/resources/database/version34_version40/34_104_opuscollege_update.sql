...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('college','A','Y',3.67);

-- Table: audit.person_hist

-- DROP TABLE audit.person_hist;

CREATE TABLE audit.person_hist
(
...
ALTER TABLE audit.person_hist OWNER TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.person_hist TO postgres;
...
-- Table: audit.studentexpulsion_hist

-- DROP TABLE audit.studentexpulsion_hist;

CREATE TABLE audit.studentexpulsion_hist
(
  operation character(1) NOT NULL,
  id integer NOT NULL ,
  studentid integer NOT NULL,
...
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.studentexpulsion_hist TO postgres;


-- Table: audit.studentabsence_hist

-- DROP TABLE audit.studentabsence_hist;

CREATE TABLE audit.studentabsence_hist
(
 operation character(1) NOT NULL,
  id integer NOT NULL ,
  studentid integer NOT NULL,
...
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.studentabsence_hist TO postgres;


-- Table: audit.gradedsecondaryschoolsubject_hist

-- DROP TABLE audit.gradedsecondaryschoolsubject_hist;

CREATE TABLE audit.gradedsecondaryschoolsubject_hist
(
  operation character(1) NOT NULL,
  id integer NOT NULL ,
  ...
  writewho character varying NOT NULL ,
  writewhen timestamp without time zone NOT NULL DEFAULT now(),
  secondaryschoolsubjectgroupid integer NOT NULL DEFAULT 0,
  "level" character(1)
);

ALTER TABLE audit.gradedsecondaryschoolsubject_hist OWNER TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE,REFERENCES, TRIGGER ON TABLE audit.gradedsecondaryschoolsubject_hist TO postgres;