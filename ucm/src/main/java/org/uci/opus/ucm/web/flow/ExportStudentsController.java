...
@Controller
@RequestMapping(value="/ucm/exportstudents.view")
public class ExportStudentsController {

    private static Logger log = LoggerFactory.getLogger(ExportStudentsController.class);
    ...
    public ExportStudentsController()
    {
    	viewName = "/ucm/ucm/exportStudents";
    }
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request,
        ...
        if (StringUtil.isNullOrEmpty(operation ,true)) {
        	items = uCMManager.findStudentsByNameAsMaps(parameterMap);
            ...
            parameterMap.put("studentsIds", Utils.toIntArray(request.getParameterValues("studentsIds")));
        	
            items = uCMManager.findStudentsForExport(parameterMap);
            ...
            String downloadFileName = messageSource.getMessage("jsp.general.studentslists", null , currentLoc);
         	...
         	parameterMap.remove("searchValue");
         	
         			
         	String[] fields = request.getParameterValues("fieldsToExport");
         	String fileContent = "";
         	
         	if("csv".equalsIgnoreCase(reportFormat)){
         		fileContent = Utils.toCsv(items, fields);
         		response.setContentType("text/csv");
         	} else if("xml".equalsIgnoreCase(reportFormat)){
         		fileContent = Utils.toXml(items, fields);
