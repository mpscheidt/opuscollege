...
@Component
public class ImportCedStudentsResultsFormValidator implements Validator {

    @Override
    public boolean supports(Class<?> clazz) {
        return ImportCedStudentsResultsForm.class.isAssignableFrom(clazz);    }

    @Override
    public void validate(Object object, Errors errors) {
        
        ImportCedStudentsResultsForm form = (ImportCedStudentsResultsForm) object;
