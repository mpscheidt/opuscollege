...
@Service
public class LatestTimeUnitFullResultDTOFactory {
    ...
    /**
     * Create a {@link LatestTimeUniFullResultDTO} object for the given studyPlan.
     * 
     * @param studyPlan
     * @return
     */
    public LatestTimeUniFullResultDTO forStudyPlan(StudyPlan studyPlan) {
        LatestTimeUniFullResultDTO timeUnit = new LatestTimeUniFullResultDTO();
