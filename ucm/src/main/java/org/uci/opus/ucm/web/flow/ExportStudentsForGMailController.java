...
@Controller
@RequestMapping(value="/ucm/gmailexportstudentstimeunit.view")
public class ExportStudentsForGMailController {

    private static Logger log = LoggerFactory.getLogger(ExportStudentsForGMailController.class);
    ...
    public ExportStudentsForGMailController()
    {
    	viewName = "/ucm/ucm/exportStudentsByTimeUnitForGMail";
    }
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request,
        ...
        String reportName = ServletUtil.getParamSetAttrAsString(request, "reportName", "StudentsExportForGMail");
        ...
        if (StringUtil.isNullOrEmpty(operation ,true)) {
			...
			mav = reportController.createReport(session, "gmail/" + reportName ,
                    requestWhereClause,
