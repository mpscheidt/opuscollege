...
<div id="tabwrapper">
    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                 <a href="<c:url value='/ucm/moodleoverview.view'/>">
                	<fmt:message key="jsp.general.backtooverview" />
                 </a> 
                 &nbsp; > &nbsp;
                 Moodle - <fmt:message key="moodle.exportstudentsbytimeunit.header"/>
            </legend>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <div id="tableDiv">
           	    <%@ include file="../includes/tables/table_studentsbytimeunit.jsp"%>
            </div>
        </form>
