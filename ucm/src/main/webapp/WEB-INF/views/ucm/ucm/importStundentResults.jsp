		...
		<td class="required">
			...
			<spring:message var="radioLabel" code="jsp.${fileModel.value}" /> 
		 	...
		 	<form method="POST" id="getResultsFormForm" name="getResultsFormForm">
				...
				<input type="hidden" name="where.academicYearId" value="${academicYearId}" />
		 	...
		 	<c:choose>
		 		<c:when test="${resultsForm.fileModel.value == 'STANDARD_PAUTA'}">
		 			
		 			<a href="#" 
		 				id="lnkGetResultsForm"
		 				onclick="document.getResultsFormForm(); return false;"
		 			>
