...
public class UCMManagerMock implements UCMManagerInterface {

    private Map<String, String> highestStudentCodes = new HashMap<String, String>();

    /**
     * put highest student code for given faculty and year.
     * @param facultyCode
     * @param year two-digits
     * @param highestStudentCode
     */
    public void putHighestStudentCode(String branchCode, String year, String highestStudentCode) {
        highestStudentCodes.put(branchCode + "@" + year, highestStudentCode);
    }

    public String findHighestStudentCode(String branchCode, String year) {
        return highestStudentCodes.get(branchCode + "@" + year);
    }

	@Override
	public List<Map<String, Object>> findCTUsInStudyPlans(
	...
	@Override
	public List<Map<String, Object>> findStudentsByNameAsMaps(
			Map<String, Object> map) {
		// TODO Auto-generated method stub
		return null;
	}
