...
<!-- To use this include, the form needs to be named "reportFormatForm" -->
			...
			<td width="80"><input id="reportFormatScreen" name="reportFormat" value="html" type="radio" onchange="this.form.submit();"
			...
			<td width="80"><input id="reportFormatPDF" name="reportFormat" value="pdf" type="radio" onchange="this.form.submit();"
			...
			<td width="100"><input id="reportFormatExcel" name="reportFormat" value="xls" type="radio" onchange="this.form.submit();"
