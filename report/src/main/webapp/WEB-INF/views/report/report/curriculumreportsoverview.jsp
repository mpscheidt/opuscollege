...
<c:set var="screentitlekey">jsp.curriculumreports.header</c:set>
        ...
        <div id="tabcontent">
            ...
            <fieldset>
               ...
               <table class="reportTable">
                   ...
                   <tbody>
                       <tr>
                           <td width="200"><a href="<c:url value='/report/curriculaperyear.view?reportName=CurriculumPerYear'/>"><fmt:message key="jsp.report.curriculumperyear" /></a>
                           <td width="500"><span class="description"><fmt:message key="jsp.studentsreports.description.curriculumPerYear"/></span></td>
                       </tr> 
<%-- the same info as the studies offered report is already available as one of the statistics reports
                       <tr>
                           <td width="200"><a href="<c:url value='/report/studiesoffered.view?reportName=StudiesOffered.xml'/>"><fmt:message key="jsp.general.studiesOffered" /></a>
