...
/* jQuery(function() {
  jQuery("#reportButton").click(
          function(){
              createReport('<c:url value='/report/curriculaperyear.view' />' , buildQueryString("reportParam , reportFormat"));              
          });
 });*/
</script>
    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="jsp.report.curriculumperyear"/>
             </legend>
             
<%--            <form id="mainForm" name="mainForm">
                <input type="hidden" name="operation" id="operation" value="" /> --%>
                <%@ include file="../../includes/filtersCurriculumTable.jsp"%>
<%--            </form> --%>
        </fieldset>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <div id="tableDiv">
                <%@ include file="../../includes/tables/table_curriculumperyear.jsp" %>
            </div>
        </form>
    </div>
