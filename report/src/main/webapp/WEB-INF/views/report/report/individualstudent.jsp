    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="${titleKey}" /> (<fmt:message key="jsp.general.individualreport" />)
            </legend>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
                ...
                <table>
                    <tr >
                        <td style="vertical-align:bottom;" width="100">
                            <label><fmt:message key="jsp.reports.OutPutReport"/>:</label>
                        </td>
                        <td>
            ...
            <div id="tableDiv">
           	 <%@ include file="../../includes/tables/table_individualstudent.jsp"%>
            </div>
        </form>
