    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="${titleKey}" /> (<fmt:message key="jsp.general.studyplanreport"/>)
            </legend>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <fieldset>
                <table>
                    ...
                    <td width="200" style="padding:20px 0px 10px 0px" >
                         ...
                         onclick="
                         			this.form.orderBy.value=document.getElementById('orderBy').value;
            ...
            <div id="tableDiv">
           	    <%@ include file="../../includes/tables/table_studyplanreport.jsp"%>
            </div>
        </form>             
