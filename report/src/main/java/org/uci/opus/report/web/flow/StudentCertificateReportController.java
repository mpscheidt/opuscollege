...
@Controller
@RequestMapping(value="/report/studentcertificate.view")
@SessionAttributes({"reportForm"})
public class StudentCertificateReportController extends OpusReportsController2 {
    ...
    public StudentCertificateReportController() {
    	super();
    	viewName = "/report/report/studentcertificate";
    }
   ...
   public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       mav.addObject("action", "/report/studentcertificate.view");
       ...
       if (StringUtil.isNullOrEmpty(operation ,true)) {
           ...
           List<Map<String , Object>> students = this.reportMapper.findStudyplanCardinalTimeUnits(parameterMap);
    ...
    public ModelAndView processSubmit(
			...
			ModelAndView mav = new ModelAndView("redirect:/report/studentcertificate.view");
			...
			String reportFormat = ServletUtil.getParamSetAttrAsString(request, "reportFormat", "pdf");
		    String reportName = ServletUtil.getParamSetAttrAsString(request, "reportName", "StudentCertificate");
		    String orderBy = ServletUtil.getParamSetAttrAsString(request, "orderBy", "person_surnamefull");
			...
			if ("makereport".equalsIgnoreCase(operation)) {
		           ...
		           //get global properties from database
		           Map allProperties = getUserProperties("studentcertificate");
