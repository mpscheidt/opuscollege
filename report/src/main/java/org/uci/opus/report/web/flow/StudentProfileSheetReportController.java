...
@Controller
@RequestMapping(value="/report/studentprofilesheet.view")
@SessionAttributes({"reportForm"})
public class StudentProfileSheetReportController extends OpusReportsController2 {

    private static Logger log = LoggerFactory.getLogger(StudentProfileSheetReportController.class);
    ...
    public StudentProfileSheetReportController(){
    	       super();
    	       viewName = "/report/report/studentprofilesheet";
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String reportName = ServletUtil.getParamSetAttrAsString(request, "reportName", "StudentProfile");
        ...
        request.setAttribute("action", "/report/studentprofilesheet.view");
        ...
        if (StringUtil.isNullOrEmpty(operation ,true)) {
            ...
            String downloadFileName = ServletUtil.getParamSetAttrAsString(request, "downloadFileName"
					, messageSource.getMessage("jsp.general.studentprofilesheet", null, locale));
       ...
       downloadFileName = downloadFileName.replaceAll("\\s+", "_");
		...
		mav = reportController.createReport(session, reportName,
            ...
            reportController.putModelParameters(mav, getUserProperties("studentprofile"));
        }
