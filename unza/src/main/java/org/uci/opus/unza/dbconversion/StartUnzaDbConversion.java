 ...
 *
 */
public class StartUnzaDbConversion {
    ...
    public static void main(String[] params) throws Exception {
        ApplicationContext context =
            new ClassPathXmlApplicationContext(new String[] {
                  ...
                  , "org/uci/opus/unza/unza-beans.xml"
                  , "org/uci/opus/unza/applicationContext-service.xml"
                  , "org/uci/opus/fee/applicationContext-service.xml"
                  });
        
        UnzaDbConversion dbConversion = (UnzaDbConversion) context.getBean("unzaDbConversion");
