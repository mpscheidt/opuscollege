 ...
 *
 */
public class UnzaStudentNumberGenerator implements StudentNumberGeneratorInterface {
	
    private static final String INITIAL_RUNNING_NUMBER = "00001";
	@Autowired private UnzaManagerInterface unzaManager;
	
	private static Logger log = Logger.getLogger(UnzaStudentNumberGenerator.class);
	...
	public String createUniqueStudentCode(String key, int organizationalUnitId, Student student) {
        ...
        String highestRunningNumber = unzaManager.findHighestStudentCodeRunningNumber(year);
