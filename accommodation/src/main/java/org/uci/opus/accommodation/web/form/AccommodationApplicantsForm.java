...
public class AccommodationApplicantsForm {

	private String txtErr;
	private String txtMsg;
	private List<StudentAccommodation> applicants;
	...
	public List<StudentAccommodation> getApplicants() {
		return applicants;
	}
	
	public void setApplicants(List<StudentAccommodation> applicants) {
