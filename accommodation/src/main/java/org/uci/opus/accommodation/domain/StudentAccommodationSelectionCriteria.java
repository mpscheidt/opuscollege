...
public class StudentAccommodationSelectionCriteria {
	private int id;
	...
	/**
	 * Gets the state of the HostelType
	 * @return
	 */
	...
	/**
	 * Sets the state of the HostelType. Possible values are 'Y' and 'N'
	 * Default value is 'Y'
	 * 
	 * @param active
	 */
