...
<body>
	<div id="tabwrapper">
		...
		<div id="tabcontent">
			<form:form method="post" action="allocateResource.view" commandName="studentAccommodationResourceForm">
				...
				<fieldset>
					...
					<table>
						...
						<tr>
							...
							<td><form:select path="accommodationResourceId">
								<form:option value="0"><fmt:message key="jsp.accommodation.chooseOption" /></form:option>
								<form:options items="${accommodationResources}" itemValue="id" itemLabel="name" />
							</form:select></td>
							<td><form:errors path="accommodationResourceId" cssClass="error" /></td>
						</tr>
						<tr>
							<td><fmt:message key="jsp.accommodation.commentWhenCollecting" /></td>
							<td><form:textarea path="commentWhenCollecting" /></td>
							<td>&nbsp;</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
				...
				<c:when test="${not empty studentAccommodationResources}">
					<!-- <fieldset>
						...
						<tr>
							...
							<th><fmt:message key="jsp.accommodation.comment" /></th>
