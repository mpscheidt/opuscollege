...
<body>
	...
	<div id="tabwrapper">
		...
		<div id="tabcontent">
			<form:form method="post" action="multipledeallocation.view"
				commandName="studentsForm">
				<input type="hidden" value="<c:out value="${param.preferredLanguage}" />" name="preferredLanguage" />
				<fieldset>
					<legend>
						<fmt:message key="jsp.accommodation.multipleRoomDeallocation" />
					</legend>
					<table>
						<tr>
							<td><fmt:message key="jsp.accommodation.higherEducation" />
							</td>
			...
			<c:choose>
				<c:when test="${not empty accommodatedStudents }">
					<form method="post" action="multipledeallocation.view">
						<c:set var="allEntities" value="${accommodatedStudents}"
							scope="page" />
						...
						<table id="tblListStudentAccommodation" class="tabledata">
							<tr>
								<th><input type="submit" name="deallocate"
									value="Deallocate" /></th>
							...
							<c:forEach items="${accommodatedStudents }"
								var="studentAccommodation">
								<tr>
									<td><input type="checkbox" name="studentAccommodationId"
										checked="checked" value="<c:out value='${studentAccommodation.id }' />" /></td>
