...
@Component
public class AcademicYearFeeTransition implements
        AcademicYearTransitionExtPoint {
    ...
    public void transfer(int sourceAcademicYearId, int targetAcademicYearId) {
        ...
        for (int feeId : feeMapper.findFeeIdsForAcademicYear(sourceAcademicYearId)) {
            int targetFeeId = feeMapper.transferAcademicYearFee(feeId, targetAcademicYearId);
            feeServiceExtensions.transfer(feeId, targetFeeId);
        }
        feeDeadlineMapper.transferAcademicYearFeeDeadlines(sourceAcademicYearId, targetAcademicYearId, intervalInDays + " days");
    }
