...
@Component
public class SubjectFeeTransition implements
        SubjectStudyGradeTypeTransitionExtPoint {
    ...
    public void transfer(int sourceAcademicYearId, int targetAcademicYearId) {
        ...
        feeMapper.transferSubjectFees(sourceAcademicYearId, targetAcademicYearId);
        feeDeadlineMapper.transferSubjectFeeDeadlines(sourceAcademicYearId, targetAcademicYearId, intervalInDays + " days");
