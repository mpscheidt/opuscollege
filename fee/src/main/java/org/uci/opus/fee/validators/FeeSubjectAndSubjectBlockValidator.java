 ...
 * 
 */
public class FeeSubjectAndSubjectBlockValidator implements Validator {

    private static Logger log = LoggerFactory.getLogger(FeeSubjectAndSubjectBlockValidator.class);
...
//        ValidationUtils.rejectIfEmpty(errors, "postgraduateDiscountPercentage", "invalid.empty.format");
        ...
        /* subjectStudyGradeTypeId, subjectBlockStudyGradeTypeId */
        int ssgtId = fee.getSubjectStudyGradeTypeId();
        int sbsgtId = fee.getSubjectBlockStudyGradeTypeId();
        if (ssgtId == 0 && sbsgtId == 0) {
            errors.rejectValue("subjectStudyGradeTypeId", "invalid.id.format");
            errors.rejectValue("subjectBlockStudyGradeTypeId", "invalid.id.format");
        }
