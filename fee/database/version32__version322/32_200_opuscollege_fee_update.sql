...
-- table fee_feeType
-------------------------------------------------------
DROP TABLE IF EXISTS opuscollege.fee_feeType CASCADE;
DROP SEQUENCE IF EXISTS opuscollege.fee_feeType_seq;

-------------------------------------------------------
-- table fee_feeCategory
-------------------------------------------------------
INSERT INTO opuscollege.lookuptable(tablename, lookuptype) VALUES ('fee_feecategory', 'Lookup');
