...
public class CbuThesisResultFormatter extends ThesisResultFormatter {
    ...
    public String get(Object obj) {
        ...
        s.append(" (");
        s.append(thesisResult.getGradePoint());
        s.append(")");
        return s.toString();
    }
...
//
//        EndGrade endGrade = resultManager.calculateEndGradeForMark(thesisResult.getMark(), endGradeTypeCode, preferredLanguage, lastAcademicYear.getId());
//        if (endGrade != null) {
