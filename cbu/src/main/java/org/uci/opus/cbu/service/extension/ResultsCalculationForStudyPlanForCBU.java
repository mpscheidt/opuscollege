...
/* MoVe 2011-08-25 - OLD VERSION, general ZAMBIA version used now
 * 
...
public class ResultsCalculationForStudyPlanForCBU 
    implements ResultsCalculations {

    private static Logger log = LoggerFactory.getLogger(ResultsCalculationForStudyPlanForCBU.class);
