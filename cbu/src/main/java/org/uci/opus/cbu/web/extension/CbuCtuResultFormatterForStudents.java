...
import org.uci.opus.college.web.extpoint.CtuResultFormatterForStudents;

public class CbuCtuResultFormatterForStudents extends CtuResultFormatterForStudents {
...
//    @Autowired private StudyManagerInterface studyManager;
    ...
    public String get(Object obj) {
        ...
        String endGrade = ctuResult.getEndGradeComment();
        if (!StringUtils.isEmpty(endGrade)) {
            s.append(endGrade);
        }
...
////
////            String endGrade = resultManager.calculateEndGradeForMark(ctuResult.getMark(), endGradeTypeCode, preferredLanguage, studyGradeType.getCurrentAcademicYearId());
////
