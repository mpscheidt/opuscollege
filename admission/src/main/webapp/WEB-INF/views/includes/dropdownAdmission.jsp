            ...
            <c:forEach var="lookup" items="${allLookups}">
                <c:choose>
                    <c:when test="${lookup.code == status.value}">
                        <option value="<c:out value='${lookup.code}'/>" selected="selected"><c:out value='${lookup.description}'/></option>
                    </c:when>
                    <c:otherwise>
                        <option value="<c:out value='${lookup.code}'/>"><c:out value='${lookup.description}'/></option>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </select>
