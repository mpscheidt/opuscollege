...
import org.uci.opus.college.web.extpoint.SubjectResultFormatterForStudents;

public class CbuSubjectResultFormatterForStudents extends SubjectResultFormatterForStudents  {
...
//    @Autowired private SubjectManagerInterface subjectManager;
    ...
    public String get(Object obj) {
        ...
        String endGradeComment = subjectResult.getEndGradeComment();
        s.append(endGradeComment);
        BigDecimal gradePoint = subjectResult.getGradePoint();
        if (gradePoint != null) {
            s.append(" (").append(gradePoint).append(")");
        }
...
//        subjectResult.setGradePoint(gradePoint);
//
//        // the following should not be necessary since it's stored in the DB
////        if (subjectResult.getEndGradeComment() == null || "".equals(subjectResult.getEndGradeComment())) {
