...
public class DbConversion {
    ...
    @Autowired StudyPlanMigrator studyPlanMigrator;
    
    public void doMigration() throws Exception {
    	
    	log.info("Starting database conversion");
        
        //Migrate Schools and Departments
    	schoolMigrator.convertSchoolsAndOrgUnits();
    	...
    	// -> Run database upgrade 402_mulungushi.sql from Opus user interface
    	
    	// then move the students and their results
        studentMigrator.convertStudents();

        // migrate study plans
    	studyPlanMigrator.convertStudyPlans();

    	//fix endgrades for newly added acadmicyears
//    	log.info("Starting conversion of endgrades");
//    	endGradeMigrator.convertEndGrades();
    	
    	// create the forgotten cardinalTimeUnitStudyGradeTypes
    	programmeMigrator.addCardinalTimeUnitStudyGradeTypes();
