...
<td><label><fmt:message key="jsp.general.subject" /></label></td>
    ...
    <tr>
        ...
        <td><label><fmt:message key="jsp.general.examination" /></label></td>
        <td>
            <select 
                id="examinationId"
                name="examinationId"
            ...
            >
            <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
            <option value="finalgrade" <c:if test="${resultsForm.resultType == 'finalgrade'}"> selected="selected" </c:if> ><fmt:message key="jsp.discipline.grade" /></option>
            <option value="resit" <c:if test="${subjectResultsForm.resultType == 'resit'}"> selected="selected" </c:if> ><fmt:message key="general.exam.resit" /></option>
            <c:forEach var="examination" items="${subjectResultsForm.subject.examinations}">
             <c:choose>
