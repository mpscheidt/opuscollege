...
<div id="tabwrapper">
    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                 <a href="<c:url value='/ucm/exportoverview.view'/>">
                <fmt:message key="jsp.general.backtooverview" /> </a> &nbsp; > &nbsp;
                <fmt:message key="exportstudents.header"/>
            </legend>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <fieldset>
            <legend>
            	<fmt:message key="general.choosefields"/>
            </legend>
            <table>
            	
            	<c:forEach varStatus="status" begin="1" end="${fn:length(studentFieldsMap)}">
            		<tr>
            			<td>${status.count}</td>
            			<td>
            			<select name="fieldsToExport">
            			<option value=""><fmt:message key="jsp.selectbox.choose" /></option>
            				<c:forEach var="entry" items="${studentFieldsMap}">
            ...
            <fieldset>
                <table>
                    <tr>
                        ...
                        <td>
                            <%@ include file="../includes/csvXmlFormats.jsp"%>
                        </td>
                    </tr>
                    <tr>
                        <td width="200" style="padding:20px 0px 10px 0px" >
                            ...
                            <input type="hidden" name="studyPlanStatusCode" value=""/>
                            <input type="hidden" name="genderCode" value=""/>
                            <input type="hidden" name="cardinalTimeUnitNumber" value=""/>
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <div id="tableDiv">
           	    <%@ include file="../includes/tables/table_exportStudents.jsp"%>
            </div>
        </form>
