...
<sec:authorize access="hasRole('UPDATE_INSTITUTIONS')">
            ...
            <input type="hidden" name="currentAcademicYearId" value="${currentAcademicYearId}" />
            ...
            <table>
                <tr>
                    ...
                    <td>
                    <select name="institutionId" onchange="document.getElementById('branchId').value='0';document.getElementById('organizationalUnitId').value='0';document.getElementById('primaryStudyId').value='0';document.getElementById('searchValue').value='';document.universities.submit();">
...
<sec:authorize access="hasAnyRole('UPDATE_BRANCHES','UPDATE_INSTITUTIONS')">
            ...
            <table>
                <tr>
                    ...
                    <td>
                    <select name="branchId" id="branchId" onchange="document.getElementById('organizationalUnitId').value='0';document.getElementById('primaryStudyId').value='0';document.getElementById('searchValue').value='';document.branches.submit();">
                        <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
...
<sec:authorize access="hasAnyRole('READ_PRIMARY_AND_CHILD_ORG_UNITS','UPDATE_ORG_UNITS','UPDATE_BRANCHES','UPDATE_INSTITUTIONS')">
            ...
            <table>
                <tr>
                    ...
                    <td>
                    <select name="organizationalUnitId" id="organizationalUnitId" onchange="document.getElementById('primaryStudyId').value='0';document.getElementById('searchValue').value='';document.organizationalunits.submit();">
                        <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
