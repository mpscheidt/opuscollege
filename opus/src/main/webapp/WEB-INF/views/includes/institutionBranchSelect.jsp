...
<c:if test="${showInstitutions}">
    <form name="institutions" action="<c:url value='${action}'/>" method="post" target="_self">
	...
	<table>
	    <tr>
	        ...
	        <select name="institutionId" onchange="document.getElementById('branchId').value='0';
                                                   document.institutions.currentPageNumber.value='1';
                                                   document.institutions.submit();">
...
<c:if test="${showBranches}">
    ...
    <table>
        <tr>
            ...
            <td>
            <select name="branchId" id="branchId" onchange="document.branches.currentPageNumber.value='1';
                                                            document.branches.submit();">
                <option value="0"><fmt:message key="jsp.selectbox.all" /></option>
                <c:choose>
