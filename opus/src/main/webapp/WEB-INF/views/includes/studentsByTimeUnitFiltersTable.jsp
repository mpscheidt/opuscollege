...
<%-- TODO it doesn't really make sense to have studygradetype filter here,
    because selecting a studygradetype will result in only one row in the table.
    Maybe make one filter for gradetype (and even one for study form and study time) --%>
        <td>
            <select 
