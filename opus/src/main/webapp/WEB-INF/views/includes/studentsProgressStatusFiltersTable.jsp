...
<table width="100%">
    ...
    <tr>
        ...
        <td width="200">
            ...
            <select name="cardinalTimeUnitNumber" id="cardinalTimeUnitNumber" onchange="
                document.mainForm.submit();">
    ...
    <tr>
        ...
        <td><label><fmt:message key="jsp.general.progressstatus" /></label></td>
        <td><select
                name="progressStatusCode" id="progressStatusCode"
                class="reportParam"
                onchange="document.mainForm.submit();"                 
            >
            <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
            <c:forEach var="oneStatus" items="${allProgressStatuses}">
                <c:choose>
                    <c:when test="${oneStatus.code == progressStatusCode}">
