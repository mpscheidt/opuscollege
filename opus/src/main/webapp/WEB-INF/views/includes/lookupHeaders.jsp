...
<%--
Checks the lookup type and add the needed headers
--%>
...
<c:choose>
    ...
    <c:when test="${lookupType == 'Lookup2'}">
        <th><fmt:message key="jsp.general.province" /></th>
    </c:when>
    ...
    <c:when test="${lookupType == 'Lookup4'}">
        <th><fmt:message key="jsp.general.district" /></th>
    </c:when>
    
    <c:when test="${lookupType == 'Lookup5'}">
        <th><fmt:message key="jsp.general.country" /></th>
    </c:when>
