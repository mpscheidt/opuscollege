...
<c:choose>
                        ...
                        <td>
                            <c:choose>
                                ...
                                <a href="#" 
                                    class="reportLink" 
                                    target="_self"
                                    onclick='createReport("<c:url value="/report/studentcertificate.view" />" 
                                                , "where.studyplan.id=${student.studyplanid}&downloadFileName=<fmt:message key='jsp.general.studentcertificate'/>_${student.firstnamesfull} ${student.surnamefull}" +  buildQueryStringByClass("reportParam"));return false;'
                                    >
    ...
    <c:otherwise>
        ...
        <a target="_self" href="<c:url value='/report/studentcertificate.view'/>?<%=request.getQueryString() %>&showAll=true">
