    ...
    <form name="universities" action="<c:url value='${action}'/>" method="post" target="_self">
        ...
        <table>
            <tr>
                ...
                <td>
                <select name="institutionId" onchange="document.getElementById('branchId').value='0';document.getElementById('organizationalUnitId').value='0';document.getElementById('studyId').value='0';document.universities.submit();">
    ...
    <form name="branches" action="<c:url value='${action}'/>" method="post" target="_self">
        ...
        <table>
            <tr>
                ...
                <td>
                <select name="branchId" id="branchId" onchange="document.getElementById('organizationalUnitId').value='0';document.getElementById('studyId').value='0';document.branches.submit();">
                    <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
    ...
    <form name="organizationalunits" action="<c:url value='${action}'/>" method="post" target="_self">
        ...
        <table>
            <tr>
                ...
                <td>
                <select name="organizationalUnitId" id="organizationalUnitId" onchange="document.getElementById('studyId').value='0';document.organizationalunits.submit();">
                    <option value="0"><fmt:message key="jsp.selectbox.choose" /></option>
