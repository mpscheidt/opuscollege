...
<div id="tabwrapper">
    ...
    <div id="tabcontent">
        ...
        <form:form method="POST" commandName="studentsclassgroupform" >
    
        <fieldset>
            <legend>
                <fmt:message key="studentsclassgroup.header" />
            </legend>
            
            <form:select path="orgUnitId" onchange="this.form.submit()">
                <form:option value="0"><fmt:message key="jsp.selectbox.choose" /></form:option>
                <form:options items="${studentsclassgroupform.orgUnits}" 
                    itemValue="id"
                    itemLabel="organizationalUnitDescription" />
            </form:select>
            
            <form:select path="studyGradeTypeId" onchange="this.form.submit()">
                <form:option value="0"><fmt:message key="jsp.selectbox.choose" /></form:option>
                <form:options items="${studentsclassgroupform.studyGradeTypes}" 
                    itemValue="id"
