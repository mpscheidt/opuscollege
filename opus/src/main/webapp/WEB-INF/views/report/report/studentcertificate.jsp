...
<c:set var="screentitlekey" value="jsp.general.${fn:toLowerCase(reportForm.reportName)}" />
    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="jsp.general.${fn:toLowerCase(reportForm.reportName)}" />
            </legend>
	...
	<fieldset>
		<legend>
			<fmt:message key="jsp.general.properties"/>
			 ...
			 <%@ include file="../../includes/studentcertificate_userparameters.jsp"%>
	    
	</fieldset>
	<c:url var="reportFormAction" value="${action}"/>
        <form name="reportForm" id="reportForm" target="_blank" method="POST" action="${reportFormAction}">
            <fieldset>
                <table>
                    <tr >
                    ...
                    <td width="200" style="padding:20px 0px 10px 0px" >
                            <input type="submit" id="reportButton"
                             value="<fmt:message key='jsp.general.create.report' />"
                                 ...
                                 "
                             />
                            <input type="hidden" name="downloadFileName" value="<fmt:message key='jsp.general.studentcertificate'/>"/>
            ...
            <input type="hidden" name="reportName" class="reportParam" value="${reportForm.reportName}"/>
            <div id="tableDiv">
           	 <%@ include file="../../includes/tables/table_studentcertificate.jsp"%>
            </div>
        </form>             
