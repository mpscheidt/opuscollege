    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="jsp.studentsreports.studentsByTimeUnit"/>
             </legend>
        
        <form id="mainForm" name="mainForm">
        <input type="hidden" name="operation" id="operation" value="" />     
            <%@ include file="../../includes/studentsProgressStatusFiltersTable.jsp" %>
            ...
            <table>
                ...
                <td width="200" style="padding:20px 0px 10px 0px" >
                     <input type="submit" id="reportButton"
                         ...
                         onclick="document.getElementById('operation').value = 'makereport';"
                         />
                    </td>
                </tr>
            </table>
                    ...
                    <div id="tableDiv">
                   	 <%@ include file="../../includes/tables/table_studentsProgressStatus.jsp"%>
                    </div>
              </form>
