    ...
    <div id="tabcontent">
        ...
        <fieldset>
            ...
            <form id="mainForm" name="mainForm">
                ...
                <%@ include file="../../includes/reportPerSubjectFiltersTable.jsp" %>
        ...
        <fieldset>
			...
			<%@ include
				file="../../includes/reportpersubject_userparameters.jsp"%>
		</fieldset>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <div id="tableDiv">
           	    <%@ include file="../../includes/tables/table_reportpersubject.jsp"%>
            </div>
        </form>
