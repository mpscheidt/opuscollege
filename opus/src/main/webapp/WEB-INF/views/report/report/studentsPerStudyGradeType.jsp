...
<style type="text/css">
 ...
 /*jQuery(function() {
  initReportPage('<c:url value='/report/studentsByTimeUnit.view' />');
  jQuery("#reportButton").click(
          function(){
              createReport('<c:url value='/report/studentsByTimeUnit.view' />' , buildQueryString("where.studyGradeType.id, where.studyplancardinaltimeunit.cardinaltimeunitnumber, reportParam , reportFormat"));              
          });
 });*/
</script>
...
<%-- TODO Markus 2012-05-21: the status filter has to be removed or made optional; this would be a good time to move to form based controller --%>
                <%@ include file="../../includes/studentsByTimeUnitFiltersTable.jsp" %>
        ...
        <form name="reportForm" id="reportForm" target="_blank" >
            ...
            <div id="tableDiv">
           	    <%@ include file="../../includes/tables/table_studentsPerStudyGradeType.jsp"%>
            </div>
        </form>
