...
<c:set var="screentitlekey">jsp.general.studentdeclaration</c:set>
...
<div id="tabwrapper">
    ...
    <div id="tabcontent">
        ...
        <fieldset>
            <legend>
                ...
                <fmt:message key="jsp.general.studentdeclaration" />
            </legend>
	...
	<fieldset>
		<legend>
			<fmt:message key="jsp.general.properties"/>
			 ...
			 <%@ include file="../../includes/studentdeclaration_userparameters.jsp"%>
	...
	<c:url var="reportFormAction" value="${action}"/>
        <form name="reportForm" id="reportForm" target="_blank" method="POST" action="${reportFormAction}">
                    ...
                    <td width="200" style="padding:20px 0px 10px 0px" >
                            <input type="submit" id="reportButton"
                             value="<fmt:message key='jsp.general.create.report' />"
                                 ...
                                 "
                             />
                            <input type="hidden" name="downloadFileName" value="<fmt:message key='jsp.general.studentdeclaration'/>"/>
            ...
            <div id="tableDiv">
           	 <%@ include file="../../includes/tables/table_studentdeclaration.jsp"%>
            </div>
        </form>             
