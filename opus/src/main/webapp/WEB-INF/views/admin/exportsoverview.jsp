...
<body>
    ...
    <div id="tabwrapper">
        ...
        <div id="tabcontent">
            ...
            <fieldset>
                   <legend>
                     <fmt:message key="jsp.exportations.header" />
                  </legend>
             ...
             <fieldset>
                ...
                <table>
                    <thead>
                        <tr>
                            <th width="200"><fmt:message key="jsp.general.exportation"/></th>
                            <th width="500"><fmt:message key="jsp.general.description"/></th>
                         </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td width="200"><a href="<c:url value='/college/studentsexports.view'/>"><fmt:message key="jsp.general.students" /></a>
