...
INSERT INTO opuscollege.opusprivilege(code,lang,active,description) VALUES('UPDATE_OWN_STUDYPLAN_RESULTS_PENDING_APPROVAL','en','Y','Allow each teacher to update subjects and subject block results pending approval');
