...
INSERT INTO opuscollege.appVersions (module,state,db,dbVersion) VALUES('zambia','A','Y',3.01);
...
-- EN
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','admin', 'functional administrator', 1);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','admin-C', 'academic affairs office', 2);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','admin-B', 'dean / asst. dean / asst. registrar', 3);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','admin-D', 'head of department', 4);
...
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','registry', 'registrar', 9);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','chancellor', 'dvc', 10);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','library', 'librarian', 11);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','audit', 'internal audit', 12);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','dos', 'dean of Students', 13);
INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','pr', 'pr / communication', 14);

-- not (yet) implemented
--INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','staff', 'staff member', 5);
--INSERT INTO opuscollege.role (lang,role,roleDescription,level) VALUES('en','alumnus', 'alumnus', 15);
...
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','S','AR',2.5,55,100,'Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','F','AR',0,0,54.5,'Fail','','N');
-- BSC BACHELOR (SCIENCE)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','BSC',2.5,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','BSC',2,75,85.5,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','BSC',1.5,66,74.5,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','BSC',1,56,65.5,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','BSC',0.5,46,55.5,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','BSC',0,40,45.5,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','BSC',0,35,39.5,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','BSC',0,0,34.5,'Definite Fail','','N');
-- BA BACHELOR (ART)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','BA',2.5,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','BA',2,75,85.5,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','BA',1.5,66,74.5,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','BA',1,56,65.5,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','BA',0.5,46,55.5,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','BA',0,40,45.5,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','BA',0,35,39.5,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','BA',0,0,34.5,'Definite Fail','','N');
-- MSC MASTER (SCIENCE)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','MSC',6,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','MSC',5,75,85,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','MSC',4,70,74,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','MSC',3,65,69,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','MSC',2,55,64,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','MSC',1,50,54,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','F','MSC',0,0,49,'Fail in a Supplementary Examination','','N');
-- MA MASTER (ART)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','MA',6,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','MA',5,75,85,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','MA',4,70,74,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','MA',3,65,69,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','MA',2,55,64,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','MA',1,50,54,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','F','MA',0,0,49,'Fail in a Supplementary Examination','','N');
-- DA DIPLOMA (other than MATHS AND SCIENCE)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','DA',5,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','DA',4,76,85,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','DA',3,68,75,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','DA',2,62,67,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','DA',1,56,61,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','DA',0,50,55,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','DA',0,40,49,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','DA',0,0,39,'Definite Fail','','N');
-- DSC DIPLOMA (MATHS AND SCIENCE)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','DSC',5,90,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','DSC',4,85,89,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','DSC',3,80,84,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','DSC',2,70,79,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','DSC',1,60,69,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','DSC',0,50,59,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','DSC',0,40,49,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','DSC',0,0,39,'Definite Fail','','N');
-- DIST-DEGR DISTANT EDUCATION (DEGREE PROGRAMME)
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','DIST-DEGR',5,86,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','DIST-DEGR',4,76,85,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','DIST-DEGR',3,68,75,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','DIST-DEGR',2,62,67,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','DIST-DEGR',1,56,61,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','DIST-DEGR',0,50,55,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','DIST-DEGR',0,40,49,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','DIST-DEGR',0,0,39,'Definite Fail','','N');
-- DIST DISTANT EDUCATION
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A+','DIST',5,90,100,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','A','DIST',4,85,89,'Distinction','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B+','DIST',3,80,84,'Meritorious','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','B','DIST',2,70,79,'Very Satisfactory','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C+','DIST',1,60,69,'Clear Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','C','DIST',0,50,59,'Bare Pass','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D+','DIST',0,40,49,'Fail','','N');
INSERT INTO opuscollege.endGrade (lang,code,endGradeTypeCode,gradePoint,percentageMin,percentageMax,comment,description,temporaryGrade) VALUES ('en','D','DIST',0,0,39,'Definite Fail','','N');
-- PHD DOCTOR
-- TODO !!
